...
$stmt = $pdo->prepare("SELECT value, enabled FROM system_settings WHERE setting_name = 'mail_delivered_message' LIMIT 1");
$stmt->execute();
...
$mensaje = str_replace(
    ...
    try {
        ...
        // Contenido
        $mail->isHTML(true);
        $mail->Subject = "Hemos Entregado tu Pedido #{$cp_pedido_id}";
