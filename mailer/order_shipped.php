...
$stmt = $pdo->prepare("SELECT value, enabled FROM system_settings WHERE setting_name = 'mail_shipped_message' LIMIT 1");
$stmt->execute();
...
$mensaje = str_replace(
    ...
    try {
        ...
        // Contenido
        $mail->isHTML(true);
        $mail->Subject = "Pedido #{$cp_pedido_id} Enviado";
