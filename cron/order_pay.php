...
try {
    ...
    foreach ($orders as $order) {
        ...
        // --- Variables dinámicas (para los includes)
        ...
        foreach ($channels as $channel) {
            ...
            if ($alreadySent) {
                continue; // Ya enviado → saltar este canal
            }
            ...
            if ($channel === 'whatsapp') {
                require __DIR__ . '/../ws_api/new-order.php';
            } elseif ($channel === 'email') {
                require __DIR__ . '/../mailer/order_pay.php';
            }
