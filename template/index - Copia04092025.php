                ...
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      ...
                      <div class="dropdown-banner-holder"> <a href="#"><img alt="" src="<?php echo URLBASE; ?>/template/assets/images/banners/banner-side.png" /></a> </div>
                    </div>
                    <!-- /.row --> 
                  </li>
                  <!-- /.yamm-content -->
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        <div id="hero">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            <div class="item" style="background-image: url(<?php echo URLBASE; ?>/template/assets/images/sliders/01.jpg);">
            ...
            <div class="item" style="background-image: url(<?php echo URLBASE; ?>/template/assets/images/sliders/02.jpg);">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p1.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p1_hover.jpg" alt="" class="hover-image">
                          </a> 
                       </div>
                          <!-- /.image -->
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a data-toggle="tooltip" class="add-to-cart" href="detail.php" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                              <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" href="detail.php" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                            </ul>
                          </div>
                          <!-- /.action --> 
                        </div>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p4.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p4_hover.jpg" alt="" class="hover-image">
                          </a>
                           </div>
                          <!-- /.image -->
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                           <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p3.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p3_hover.jpg" alt="" class="hover-image">
                          </a>
                           </div>
                          <!-- /.image -->
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                           <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p2.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p2_hover.jpg" alt="" class="hover-image">
                          </a> 
                          </div>
                          <!-- /.image -->
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                           <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p6.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p6_hover.jpg" alt="" class="hover-image">
                          </a> 
                          </div>
                          <!-- /.image -->
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                           <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p5.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p5_hover.jpg" alt="" class="hover-image">
                          </a>
                          </div>
                          <!-- /.image -->
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p7.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p7_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p8.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p8_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p9.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p9_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p10.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p10_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p11.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p11_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p12.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p12_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p15.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p15_hover.jpg" alt="" class="hover-image">
                          </a>
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p14.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p14_hover.jpg" alt="" class="hover-image">
                          </a>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                          <a href="detail.php">
                             <img src="<?php echo URLBASE; ?>/template/assets/images/products/p13.jpg" alt=""> 
                              <img src="<?php echo URLBASE; ?>/template/assets/images/products/p13_hover.jpg" alt="" class="hover-image">
                          </a>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="<?php echo URLBASE; ?>/template/assets/images/banners/home-banner1.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            ...
            <div class="col-md-4 col-sm-4">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="<?php echo URLBASE; ?>/template/assets/images/banners/home-banner3.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            ...
            <div class="col-md-4 col-sm-4">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="<?php echo URLBASE; ?>/template/assets/images/banners/home-banner2.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col --> 
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="wide-banner1 cnt-strip">
                <div class="image"> <img class="img-responsive" src="<?php echo URLBASE; ?>/template/assets/images/banners/home-banner.jpg" alt=""> </div>
            ...
            <div class="col-md-4">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="<?php echo URLBASE; ?>/template/assets/images/banners/home-banner4.jpg" alt=""> </div>
          ...
          <div class="blog-slider-container outer-top-xs">
            <div class="owl-carousel blog-slider custom-carousel">
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.html"><img src="<?php echo URLBASE; ?>/template/assets/images/blog-post/blog_big_01.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.html"><img src="<?php echo URLBASE; ?>/template/assets/images/blog-post/blog_big_02.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.html"><img src="<?php echo URLBASE; ?>/template/assets/images/blog-post/blog_big_03.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
